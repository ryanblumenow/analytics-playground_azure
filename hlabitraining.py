    ...
    def run(self):
        ...
        with st.sidebar:
            ...
            if choose == "Give feedback":
                ...
                with st.sidebar.form(key='columns_in_form',clear_on_submit=True): #set clear_on_submit=True so that the form will be reset/cleared once it's submitted
                    rating=st.slider("Please rate the app", min_value=1, max_value=5, value=3,help='Drag the slider to rate the app. \
        ...
        with modelsec:
            ...
            with st.expander("The models that have been included"):
                ...
                st.write("")
                modelsincluded = ["Hypothesis Testing", "Linear Regression", "Logistic Regression", "Clustering", "ANOVA", 
                "Principal Component Analysis", "Conjoint Analysis", "Neural Networks", "Decision Trees", "Ensemble Methods"]
